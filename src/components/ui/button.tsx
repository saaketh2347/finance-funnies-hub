  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white shadow-medium hover:shadow-strong transform hover:scale-105 border-0",
        secondary: "bg-gradient-secondary text-secondary-foreground shadow-soft hover:shadow-medium transform hover:scale-105",
        warm: "bg-gradient-warm text-white shadow-soft hover:shadow-medium transform hover:scale-105",
        ...
        ghost: "text-primary hover:bg-primary-light hover:text-primary-dark",
